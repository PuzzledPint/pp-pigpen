...
@Component({
  ...
  animations: [
    ...
    trigger('activeAnimation', [
      transition('* => *', [
        query('*', animate('1s ease-out', keyframes([
          style({ opacity: 1, transform: 'translateX(0) scaleX(1)', offset: 0.0 }),
          style({ opacity: .1, transform: 'translateX(+75%) scaleX(0)', offset: 0.5 }),
          style({ opacity: 1, transform: 'translateX(0) scaleX(1)', offset: 1.0 }),
        ])))])])],
})
...
export class InfoComponent implements OnInit {
  ...
  `,
    },
    {
      ...
      slug: "charter",
      fulltext: `
      <h1 dir="ltr"><span><a name="charter"></a>Puzzled Pint Charter</span></h1>
      <p dir="ltr"><span>This document acts as a constitution for Puzzled Pint event-runners, aka Game Control (GC). It defines our core values, our responsibilities, and the events that can be run under the Puzzled Pint name and brand.  </span></p>
      <h2><span>Core Philosophy</span></h2>
      <p dir="ltr"><span>These are the non-negotiable essence of Puzzled Pint.  We uphold them at all times.</span></p>
      <ul>
      <li dir="ltr">
      <p dir="ltr"><span>Nonprofit, volunteer events</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>Free to attend and play</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>Open to the public</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>Newbie-friendly and non-competitive (no prizes, no scoring)</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>In a bar or other place that serves pints</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>The 2nd Tuesday of the month, in the evening, scheduled for around 3 hours</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>Using the same puzzles as the other cities</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>For the benefit of the puzzling community:</span></p>
      </li>
      <ul>
      <li dir="ltr">
      <p dir="ltr"><span>Content is shared under a Creative Commons Noncommercial Attribution license</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>Private noncommercial events using our archive of puzzles are encouraged--we call them “Puzzled Pint Parties.”</span></p>
      </li>
      </ul>
      </ul>
      <h2 dir="ltr"><span>Core Responsibilities</span></h2>
      <p dir="ltr"><span>GC in any given city is responsible for these tasks:</span></p>
      <ul>
      <li dir="ltr">
      <p dir="ltr"><span>Secure a location each month</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>Solve or otherwise become familiar with the month’s puzzles</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>Print event materials, including puzzles, answer sheets, code sheets, etc.</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>Staff the event</span></p>
      </li>
      <ul>
      <li dir="ltr">
      <p dir="ltr"><span>Help players locate GC</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>Distribute packets to teams and record start and end times</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>Help match singleton players to one another or existing teams</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>Happily give out hints, confirm answers, and assist players as requested</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>Collect answer sheets</span></p>
      </li>
      </ul>
      <li dir="ltr">
      <p dir="ltr"><span>Record answer sheet information</span></p>
      </li>
      </ul>
      <p dir="ltr"><span>Headquarters (HQ) is responsible for these tasks:</span></p>
      <ul>
      <li dir="ltr">
      <p dir="ltr"><span>Making puzzles available before monthly events</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>Creating and updating Puzzled Pint documentation, including this Charter</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>Maintaining the website, archived content, and storage media</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>Answering questions from city GCs and the public</span></p>
      </li>
      </ul>
      <h2 dir="ltr"><span>Puzzled Pint is Noncommercial</span></h2>
      ...
      <hr /><h1 dir="ltr"><a name="regional"></a>Puzzled Pint Regional Variations</h1>
      <p dir="ltr"><span>While the Puzzled Pint Charter acts as a core constitution, this document acts as a set of amendments that individual cities may use to customize the event for local culture, geography, and other factors.</span></p>
      ...
      <p> </p>
      <p dir="ltr"><span style="font-size: 1.5em;">Options</span></p>
      <ul>
      <li dir="ltr">
      <p dir="ltr"><span>May request voluntary donations for printing and material expenses.  A few notes:</span></p>
      </li>
      <ul>
      <li dir="ltr">
      <p dir="ltr"><span>Check with host bar for their policy.  They may want a share.</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>Be careful to ensure that attendees who do not donate are just as welcome as attendees who do</span></p>
      </li>
      </ul>
      <li dir="ltr">
      <p dir="ltr"><span>Physical location options</span></p>
      </li>
      <ul>
      <li dir="ltr">
      <p dir="ltr"><span>Rotate to a new bar/restaurant every month</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>Rotate among a few core bars/restaurants</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>Use a single home bar/restaurant</span></p>
      </li>
      </ul>
      <li dir="ltr">
      <p dir="ltr"><span>Event promotion options</span></p>
      </li>
      <ul>
      <li dir="ltr">
      <p dir="ltr"><span>May operate a social media account for your area (e.g. Twitter, Facebook, etc).</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>May promote a rough regional location ahead of time (e.g. "it's in SE Portland" or “it’s downtown”)</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>May promote the actual location ahead of time (e.g. "it's in The Foo Bar")</span></p>
      </li>
      </ul>
      <li dir="ltr">
      <p dir="ltr"><span>Puzzle options</span></p>
      </li>
      <ul>
      <li dir="ltr">
      <p dir="ltr"><span>May help us write puzzles</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>May help us playtest puzzles</span></p>
      </li>
      </ul>
      <li dir="ltr">
      <p dir="ltr"><span>May rotate GC members so that folks can run the event one month and attend as a player another month.</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>May split into multiple events in a single city, especially when the event is large</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>May wear a button, t-shirt, hat or other item to identify you as GC</span></p>
      </li>
      <li dir="ltr"><span>May produce “frequent puzzler” cards, stickers, or other swag, but must not discriminate — all attending players should be offered the materials. Local GC is responsible for funding these sorts of projects. Example: Portland GC pooled personal funds and gifted all attending players screen-printed pint glasses on our anniversary month.</span></li>
      <li dir="ltr">
      <p dir="ltr"><span>May use extra physical elements in the puzzles for your city (things that are perhaps not feasible to manufacture &amp; send to other cities e.g. laser-cut, 3D printed, the "football" briefcase combination, electronic gadgets, and so on) </span></p>
      </li>
      <ul>
      <li dir="ltr">
      <p dir="ltr"><span>If used, this MUST be an optional extra or augmentation, never a replacement for the month’s puzzles</span></p>
      </li>
      </ul>
      <li dir="ltr">
      <p dir="ltr"><span>May offer flyers or swag provided by local businesses or events of interest to puzzlers (examples: a flyer for an upcoming DASH or puzzly convention; coupons for escape rooms, a call for playtesters, etc.)</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>May offer free-to-enter drawings for door prizes provided by local businesses, or provide small celebratory gifts to players so long as they are not rewards for “winning” Puzzled Pint.</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>May utilize puzzles from the archive to offer one-off Puzzled Pint branded events sponsored by the city GC.  Such one-off Puzzled Pint events must be:</span></p>
      </li>
      <ul>
      <li dir="ltr">
      <p dir="ltr"><span>Part of a local festival, convention, or other nonprofit event of interest to puzzlers. </span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>Volunteer-run, public, newbie-friendly, and free to play (while it is acceptable for attendees to pay to attend the overarching event, the Puzzled Pint portion itself must be free to play).</span></p>
      </li>
      </ul>
      <li dir="ltr">
      <p dir="ltr"><span>Duration:</span></p>
      </li>
      <ul>
      <li dir="ltr">
      <p dir="ltr"><span>May stay longer than 3 hours, if desired</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>May set a “closing” time for a city GC and tell teams beforehand</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>May wander around and warn remaining teams that GC will be leaving in 10-15minutes, if desired</span></p>
      </li>
      </ul>
      </ul>
      <p> </p>
      <hr /><h1><span><a name="comps"></a>Policy on GC accepting comps/freebies</span></h1>
      <p><span><span> </span></span></p>
      <p><span>(TL;DR: it's OK to accept occasional freebies, but do NOT ask for comps when booking)</span></p>
      <p><span><span> </span></span></p>
      <ul>
      <li dir="ltr">
      <p dir="ltr"><span>GC should NOT request any compensation in exchange for hosting PP at a specific bar</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>it's OK if bars offer freebies, but do NOT solicit comps and do NOT make it a requirement for hosting PP</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>i.e., do NOT say anything like "we'll only bring PP to your bar if you give us free drinks/food" (repeat: this is NOT OK)</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>negotiating discounts, like extended happy hour pricing or drink specials, is OK (as long as it's for ALL attendees)</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>it's also OK to accept if a player offers to buy you a drink at some point :)</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>GC should NOT accept any cash, except for donations from players specifically to cover printing/production costs</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>occasional "sponsorships" for printing/production are OK, but only accept goods or services from vendors, NOT money</span></p>
      </li>
      <li dir="ltr">
      <p dir="ltr"><span>in legal/tax terms, nothing required by PP should "inure to the benefit" of GC, especially not money!</span></p>
      </li>
      </ul>
      <p><span><span> </span></span></p>
      <p dir="ltr"><strong>Bottom line: Puzzled Pint is non-profit and volunteer-run.</strong></p>
      <p><span> </span></p>
      `,
    },
    {
...
<p>Similar to <a href="http://en.wikipedia.org/wiki/The_Game_(treasure_hunt)">The Game</a> or the <a href="http://en.wikipedia.org/wiki/MIT_Mystery_Hunt">MIT Mystery Hunt</a>, these are not typical “puzzles”. They are often direction-less, and may incorporate traditional puzzles like crosswords, word searches, cryptograms, jigsaw puzzles, word play and logic problems. If you like any sort of logic or word puzzle, you’ll like these.</p>
...
<p>Check the hints on this web site. If those aren't helpful, you can also tweet <a href="http://twitter.com/puzzledpint">@PuzzledPint</a> on the day of the event. We want you to have fun, so we will help you solve it!</p>
...
<p>To have fun. If this sounds even remotely interesting to you, you’re going to love it.</p>`
    },
    {
      ...
      slug: "authoring",
      fulltext: `
      Our puzzles are all donated for use under the <a href="https://creativecommons.org/licenses/by-nc-sa/4.0/">Creative Commons CC-BY-NC-SA International 4.0 License</a>.
    ...
    },
    {
      ...
      If you want to start Puzzled Pint in your city, see <a routerLink="onboarding">Starting up your city</a>.<br/>
      If you want to help author puzzles, see our <a routerLink="authoring">Author's Corner</a>.<br/>
...
<p> </p>`,
    ...
    },
    {
      ...
      slug: "merch",
      fulltext: `The ability to receive a free gift for your donationOur Merchandise store is coming soon.`,
    },
  ];
